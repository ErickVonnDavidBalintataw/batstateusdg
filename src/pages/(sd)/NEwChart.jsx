...
const NewChart = ({ selectedYear }) => {
    ...
    const getMatchingCampusID = useCallback(() => {
        ...
        // Uncomment this if you need to set the selected campus explicitly
        setSelectedCampus(flattenedCampuses[0]?.campus_id);
    ...
    return (
        <Card className="w-[100%]">
            ...
            <div className="grid grid-cols-5 gap-2 mt-4">
                {matchedCampusIDs &&
                    matchedCampusIDs.map((campus, index) => (
                        <div
                            key={index}
                            className={`${
                                selectedCampus &&
